...
public class TreffenPanel extends ModelPanel<Treffen> {
  ...
  private void initComponents() {
    ...
    this.letzterTagTextfield = BasicComponentFactory.createTextField(this.presentationModel.getBufferedModel(Treffen.LETZTER_TAG), false);
    this.beschreibungTextfield = BasicComponentFactory
        .createTextField(this.presentationModel.getBufferedModel(Treffen.BESCHREIBUNG), false);
    ...
    this.emailPreviewTextfield = BasicComponentFactory.createTextArea(this.presentationModel.getBufferedModel(Treffen.EMAIL_PREVIEW_TEXT),
        false);
